...
const Footer = () => {
    ...
    return(
        <Grid position={"relative"} bottom={0} width={"100%"} background={"linear-gradient(to right, #0c1726, #294d71, #101e2d)"} display={"flex"} justifyContent={"space-between"} height={"50px"} alignItems={"center"} p={"30px"}>
